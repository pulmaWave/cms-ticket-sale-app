...
var NodePanelBody = function (props) {
    ...
    var onNodeDrop = (0, react_1.useCallback)(function (node) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ports = node.ports;
                    nodeConfig = __assign(__assign({}, node), { id: "node-".concat((0, xflow_core_1.uuidv4)()), zIndex: 10, ports: __assign(__assign({}, ports), { items: (_a = ports.items) === null || _a === void 0 ? void 0 : _a.map(function (item) { return (__assign(__assign({}, item), { id: (0, xflow_core_1.uuidv4)() })); }) }) });
                    args = {
