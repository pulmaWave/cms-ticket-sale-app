...
var GraphCommandRegistry = /** @class */ (function () {
    function GraphCommandRegistry(contributionProvider) {
         ...
         */
        this.undoCommand = function () { return __awaiter(_this, void 0, void 0, function () {
            var cmd;
         ...
         */
        this.redoCommand = function () { return __awaiter(_this, void 0, void 0, function () {
            var cmd;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    GraphCommandRegistry = __decorate([
        ...
        __param(0, (0, mana_syringe_1.contrib)(interface_2.IGraphCommandContribution)),
