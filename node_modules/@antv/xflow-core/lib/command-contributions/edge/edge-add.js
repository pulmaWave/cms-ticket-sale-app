...
var AddEdgeCommand = /** @class */ (function () {
    ...
    function AddEdgeCommand() {
        var _this = this;
        /** 处理edgeConfig的兜底逻辑 */
        this.processEdgeConfig = function (args, edge) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    case 0:
                        ...
                        return [4 /*yield*/, hooks.addEdge.call(
                            ...
                            function (handlerArgs) { return __awaiter(_this, void 0, void 0, function () {
                                var cellFactory, createEdgeService, commandService, options, graph, rawEdge, res, edgeConfig, edgeCell, cell, undo;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 5:
                                            ...
                                            return [3 /*break*/, 7];
                                        case 6:
                                            edgeCell = graph.addEdge(__assign(__assign({}, edgeConfig), { 
                                                /** 由于X6的实现是React节点挂在label上的, 所以必须要给label设置值 */
                                                label: (edgeConfig === null || edgeConfig === void 0 ? void 0 : edgeConfig.label) || edgeConfig, data: __assign({}, edgeConfig) }), options);
                                            _a.label = 7;
                                        case 7:
