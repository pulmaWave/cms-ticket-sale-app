...
var CmdContext = /** @class */ (function () {
    function CmdContext() {
        ...
        this.getArgs = function () {
            /** 注入graph meta */
            var args = __assign(__assign({}, _this.args), { modelService: _this.getModelService(), commandService: _this.getCommands(), getGraphMeta: _this.getGraphMeta, getX6Graph: _this.getX6Graph, getGraphConfig: _this.getGraphConfig });
