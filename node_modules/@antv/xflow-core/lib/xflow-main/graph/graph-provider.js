...
var GraphManager = /** @class */ (function () {
    function GraphManager() {
        ...
        /** 获取X6 Graph 实例 */
        this.getGraph = function (graphId) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        graph_1 = new x6_1.Graph(__assign(__assign({ container: graphContainer, width: clientWidth, height: clientHeight }, mergedOptions), { 
                    ...
                    case 7:
                        ...
                        graph_1.on('node:moved', function (_a) {
                            ...
                            node.setData(__assign(__assign({}, nodeData), { x: position === null || position === void 0 ? void 0 : position.x, y: position === null || position === void 0 ? void 0 : position.y }));
                        });
                        graph_1.on('node:resized', function (_a) {
                            var node = _a.node;
                            var nodeData = node.getData();
                            var size = node.size();
                            node.setData(__assign(__assign({}, nodeData), { width: size === null || size === void 0 ? void 0 : size.width, height: size === null || size === void 0 ? void 0 : size.height }));
                        });
                        this.toDisposce.push(disposable_1.Disposable.create(function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
        ...
        this.renderEdgeReactLabel = function (args) { return __awaiter(_this, void 0, void 0, function () {
...
var registerGraphModule = function (register) {
    ...
    register(exports.IGraphProvider, {
        ...
        useDynamic: function (context) {
            return {
                getGraphInstance: function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                getGraphOptions: function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    register(exports.ICommandServiceProvider, {
        ...
        useDynamic: function (context) {
            return {
                getCommandService: function () { return __awaiter(void 0, void 0, void 0, function () {
                    var commandService;
                    return __generator(this, function (_a) {
    ...
    register(exports.IModelServiceProvider, {
        ...
        useDynamic: function (context) {
            return {
                getModelService: function () { return __awaiter(void 0, void 0, void 0, function () {
                    var modelService;
                    return __generator(this, function (_a) {
