...
var Category = /** @class */ (function (_super) {
    ...
    Category.prototype.drawRadio = function (container, style, item, itemHeight, x) {
        var r = itemHeight / 2;
        var lineWidth = (r * 3.6) / 8;
        var _a = [x + r, itemHeight / 2 - r], x0 = _a[0], y0 = _a[1];
        var _b = [x0 + r, y0 + r], x1 = _b[0], y1 = _b[1];
        var _c = [x0, y1 + r], x2 = _c[0], y2 = _c[1];
        var _d = [x, y0 + r], x3 = _d[0], y3 = _d[1];
